...
const AboutInfo = () => {
    ...
    return (
        <>
        <img src={signature} alt='' style={{width: '300px', marginTop: '10%'}}></img>
        <div className='header-container'>
        <h1 className='about-header'>“Try not to become a man of success, but rather become a man of value.” – Albert Einstein.</h1>
        </div>
           <div className='about-container'>
                <div className='about-info-container' >
                        <img className='img1' src={superDome} alt='' style={{height: '500px', width: '400px'}}></img>
                        <div className='about-info-text' style={{width: '600px', height: '500px' , border: 'black, solid, 1px'}}>
                            <h1 style={{color: 'beige'}}>About Jeff Hauck</h1>
                            <p className='p1'>{aboutInfo}</p>
                        </div>
                </div>
                <div className='pro-info-container' style={{marginTop: '10%'}}>
                        <img className='img1' src={headshot} alt='' style={{height: '500px', width: '400px'}}></img>
                        <div className='pro-info-text' style={{width: '600px', height: '500px' ,}}>
                            <h1 style={{color: 'beige'}}>Professional Bio</h1>
                            <p className='p1'>{professionalInfo}</p>
                        </div>
                </div>
                <div className='skills-container'>
                    <h1 style={{color: 'beige', fontSize: '50px'}}>Skills</h1>
                    <div>
                        <p>Languages</p>
                            <ul>
                                <li>JavaScript</li>
